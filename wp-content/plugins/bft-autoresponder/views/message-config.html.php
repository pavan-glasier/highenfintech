<div class="wrap">
	...
	<form method="post" onsubmit="return validateBFConfigForm(this);">
		...
		<p><label><?php _e("Notifications email(s):", 'broadfast')?></label> <input type="text" name="receivers" value="<?php echo $receivers?>" size="40"> <?php _e('(You can enter multiple notification emails separated by comma)', 'broadfast')?></p>
		...
		<p align="center"><input type="submit" value="<?php _e('Save Message', 'broadfast')?>" class="button-primary">
		<input type="button" value="<?php _e('Go Back', 'broadfast')?>" onclick="window.location='admin.php?page=bft_options';" class="button"></p>
		<input type="hidden" name="ok" value="1">
		<?php wp_nonce_field('bft_message_config');?>
	</form>
</div>
