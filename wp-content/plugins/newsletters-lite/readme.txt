...
You can have one mailing list, 500 subscribers, send 1000 emails per month, mail type is limited to local server and SMTP with no API integration with mail service providers, and the custom dynamic fields are not available. These limits should be sufficient for a personal blogger or a small business.
...
1. Search `newsletters` to find this plugin, by Tribulant.
