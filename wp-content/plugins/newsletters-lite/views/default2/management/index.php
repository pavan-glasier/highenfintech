	...
	<div class="<?php echo esc_html($this -> pre); ?> newsletters">		
		<div role="tabpanel" id="managementtabs">
			...
			<ul class="nav nav-tabs" role="tablist">
				<?php if ($this -> get_option('managementshowsubscriptions') == "Y") : ?><li role="presentation" class="nav-item active"><a class="nav-link active" aria-controls="current" role="tab" data-toggle="tab" href="#current"><?php esc_html_e('Current', 'wp-mailinglist'); ?></a></li><?php endif; ?>
				<?php if ($this -> get_option('managementallownewsubscribes') == "Y") : ?><li role="presentation" class="nav-item"><a class="nav-link" aria-controls="subscribe" role="tab" data-toggle="tab" href="#subscribe"><?php esc_html_e('Subscribe', 'wp-mailinglist'); ?></a></li><?php endif; ?>
				<?php if ($this -> get_option('managementcustomfields') == "Y") : ?><li role="presentation" class="nav-item"><a class="nav-link" aria-controls="profile" role="tab" data-toggle="tab" href="#profile"><?php esc_html_e('Profile', 'wp-mailinglist'); ?></a></li><?php endif; ?>
			...
			<div class="tab-content">
				<?php if ($this -> get_option('managementshowsubscriptions') == "Y") : ?>
				    <div role="tabpanel" class="tab-pane fade active show in" id="current">
