	...
	class newslettersBootstrap extends wpMailPlugin {
		...
		function default_styles($defaultstyles = array()) {
			...
			$defaultstyles['bootstrap'] = array(
				'name'					=>	"Bootstrap",
				'url'					=>	'/wp-content/plugins/newsletters-lite/views/assets/bootstrap-5.0.2-dist/css/bootstrap.min.css', //$this -> render_url('bootstrap-5.0.2-dist/css/bootstrap.min.css', 'assets', false),
				'version'				=>	'5.0.2',
				'deps'					=>	false,
				'media'					=>	"all",
			);
		...
		function default_scripts($defaultscripts = array()) {
			...
			$defaultscripts['bootstrap'] = array(
				'name'					=>	"Bootstrap",
				'url'					=>	'/wp-content/plugins/newsletters-lite/views/assets/bootstrap-5.0.2-dist/js/bootstrap.min.js', //$this -> render_url('bootstrap-5.0.2-dist/js/bootstrap.min.js', 'assets', false),
				'version'				=>	'5.0.2',
				'deps'					=>	array('jquery'),
				'footer'				=>	false,
			);
