...
<div class="wrap <?php echo esc_html($this -> pre); ?> newsletters">
    ...
    <form id="posts-filter" action="?page=<?php echo esc_html( $this -> sections -> subscribers); ?>" method="get">
    	...
    	<div class="alignleft actions">
    		...
    		<?php $filter_list = (!empty($_COOKIE['newsletters_filter_subscribers_list'])) ? sanitize_text_field(wp_unslash($_COOKIE['newsletters_filter_subscribers_list'])) : (isset($_GET['list']) ? sanitize_text_field(wp_unslash($_GET['list'])) : ''); ?>
