...
<div class="wrap newsletters <?php echo esc_html($this -> pre); ?>">
	<h2><?php esc_html_e('Save a Subscriber', 'wp-mailinglist'); ?></h2>
	<?php $this -> render('error', array('errors' => $errors)); ?>
	<form id="newsletters-subscriber-form" name="optinform<?php echo esc_html( $subscriber -> id); ?>" action="?page=<?php echo esc_html( $this -> sections -> subscribers); ?>&amp;method=save" method="post" enctype="multipart/form-data">
