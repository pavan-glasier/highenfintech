...
<div class="wrap newsletters <?php echo esc_html($this -> pre); ?> newsletters">
	...
	<div class="postbox" style="padding:10px;">
		...
		jQuery(document).ready(function() {	
			var ajaxdata = {type:'<?php echo esc_html($type); ?>', chart:'<?php echo esc_html($chart); ?>', from:'<?php echo esc_html($fromdate); ?>', to:'<?php echo esc_html($to); ?>', history_id:'<?php echo esc_html( $history -> id); ?>'};
