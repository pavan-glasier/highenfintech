				...
				<div id="post-body-content">
					<div id="titlediv">
						...
						<div id="edit-slug-box" class="hide-if-no-js" style="display:<?php echo (!empty($_POST['ishistory'])) ? 'block' : 'none'; ?>;">
							...
							<span id="sample-permalink" tabindex="-1"><?php echo esc_html( $newsletter_url); ?></span>
							<span id="view-post-btn"><a href="<?php echo esc_html( $newsletter_url); ?>" target="_blank" class="button button-small"><?php esc_html_e('View Newsletter', 'wp-mailinglist'); ?></a></span>
