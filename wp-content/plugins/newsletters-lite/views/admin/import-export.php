						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<tbody>
									<tr>
										<th style="padding:15px 0;"><label><input <?php echo $fieldemailcheck = ($_POST['fields']['mailinglists'] == "Y") ? 'checked="checked"' : ''; ?> onclick="jQuery('#mailinglistscolumn').toggle();" type="checkbox" name="fields[mailinglists]" value="Y" /> <?php esc_html_e('Mailing List/s', 'wp-mailinglist'); ?></label></th>
										<td>
											<span id="mailinglistscolumn" style="display:<?php echo esc_html( $fieldemaildisplay = ($_POST['fields']['mailinglists'] == "Y") ? 'block' : 'none'); ?>;">
												<b><?php esc_html_e('Column Number:', 'wp-mailinglist'); ?></b> <input type="text" class="widefat" style="width:45px;" name="mailinglistscolumn" value="<?php echo esc_attr(sanitize_text_field(wp_unslash($_POST['mailinglistscolumn']))); ?>" />
				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							...
							<td>
								<label><input <?php checked((int)$_POST['preventautoresponders'], 1, true); ?> type="checkbox" name="preventautoresponders" value="1" id="preventautoresponders" /> <?php esc_html_e('Yes, prevent the sending of current autoresponders.', 'wp-mailinglist'); ?></label>
				...
				<table class="form-table">
					<tbody>
		                ...
		                <tr>
		                	...
		                	<td>
		                		<label><input <?php echo (empty($_POST['export_purpose']) || (!empty($_POST['export_purpose']) && $_POST['export_purpose'] == "newsletters")) ? 'checked="checked"' : ''; ?> type="radio" name="export_purpose" value="newsletters" id="export_purpose_newsletters" /> <?php esc_html_e('Newsletter plugin', 'wp-mailinglist'); ?></label>
