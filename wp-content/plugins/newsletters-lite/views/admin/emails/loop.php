		        	...
		        	<?php foreach ($emails as $email) : ?>
		            	<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
			            	<th class="check-column">
					        	<input type="checkbox" name="emails[]" value="<?php echo esc_attr($email -> id); ?>" id="emails_<?php echo esc_html($email -> id); ?>" />
				        	</th>
		            		<?php if ($_GET['page'] == $this -> sections -> history) : ?>
			                	<td>
			                		<?php
			                        ...
			                        <?php if (!empty($subscriber)) : ?>
			                        	<strong><a class="row-title" href="?page=<?php echo (int) $this -> sections -> subscribers; ?>&amp;method=view&amp;id=<?php echo esc_html( $email -> subscriber_id); ?>"><?php echo esc_html( $subscriber -> email); ?></a></strong>
				...
				<?php if (empty($_GET['showall'])) : ?>
					<select class="widefat" style="width:auto;" name="perpage" onchange="change_perpage(this.value);">
						...
						<?php if (isset($_COOKIE[$this -> pre . 'emailsperpage'])) : ?>
							<option selected="selected" value="<?php echo esc_attr((int) ($_COOKIE[$this -> pre . 'emailsperpage'])); ?>"><?php echo esc_attr((int) ($_COOKIE[$this -> pre . 'emailsperpage'])); ?></option>
						<?php endif; ?>
					</select>
				<?php endif; ?>
			</div>
