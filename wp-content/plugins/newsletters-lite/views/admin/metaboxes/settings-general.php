		...
		<tbody>
			<tr>
				...
				<td>
					...
					<label><input <?php echo (!empty($mailapi) && $mailapi == "mandrill") ? 'checked="checked"' : ''; ?> type="radio" class="mailapi_select" name="mailapi" value="mandrill" id="mailapi_mandrill" /><img class="mailapi_icon" src="<?php echo esc_url_raw( $this -> render_url('images/icons/mailapis/mandrill.png', 'admin')); ?>" alt="mandrill" /> <?php esc_html_e('Mandrill', 'wp-mailinglist'); ?></label><br/>
