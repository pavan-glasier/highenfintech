	...
	<div id="minor-publishing">
		...
		<div id="misc-publishing-actions">
			...
			<div class="misc-pub-section sendfromwrapper">
				<input type="hidden" id="from" name="from" value="<?php echo (!empty($_POST['from'])) ? esc_attr(sanitize_text_field(wp_unslash($_POST['from']))) : ''; ?>" />
				<input type="hidden" id="fromname" name="fromname" value="<?php echo (!empty($_POST['fromname'])) ? esc_attr(sanitize_text_field(wp_unslash($_POST['fromname']))) : ''; ?>" />
				...
				<span id="sendfrom-value">
					<abbr title="<?php echo (empty($_POST['from'])) ? esc_html($this -> get_option('smtpfrom')) : esc_attr(sanitize_text_field(wp_unslash($_POST['from']))); ?>"><?php echo (empty($_POST['fromname'])) ? esc_html($this -> get_option('smtpfromname')) :  sanitize_text_field(wp_unslash($_POST['fromname'])); ?></abbr>
				</span>
				
				<div id="sendfromdiv" class="" style="display:none;">
					<div class="form-field">
						<label for="smtpfromname"><?php esc_html_e('From Name:', 'wp-mailinglist'); ?></label>
						<input type="text" name="smtpfromname" value="<?php echo (empty($_POST['fromname'])) ? esc_html($this -> get_option('smtpfromname')) : esc_attr(sanitize_text_field(wp_unslash($_POST['fromname']))); ?>" id="smtpfromname" />
					</div>
					<div class="form-field">
						<label for="smtpfrom"><?php esc_html_e('From Email:', 'wp-mailinglist'); ?></label>
						<input type="text" name="smtpfrom" value="<?php echo (empty($_POST['from'])) ? esc_html($this -> get_option('smtpfrom')) : esc_attr(sanitize_text_field(wp_unslash($_POST['from']))); ?>" id="smtpfrom" />
					</div>
					<p>
				...
				<div class="misc-pub-section">
					...
					<div id="sendrecurringdiv" class="" style="display:none;">
						<div class="form-field">
							...
							<input type="text" name="sendrecurringvalue" value="<?php echo esc_attr(sanitize_text_field(wp_unslash($_POST['sendrecurringvalue']))); ?>" id="sendrecurringvalue" class="widefat" style="width:45px;" />
