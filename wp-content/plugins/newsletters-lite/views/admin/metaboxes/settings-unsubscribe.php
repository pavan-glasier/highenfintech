...
<table class="form-table">
	<tbody>
		<tr>
			...
			<?php echo ( $Html -> help(__('When you delete a WordPress user under "Users" in the dashboard, the subscriber (if any) with the same email address can be deleted automatically as well.', 'wp-mailinglist'))); ?></th>
			<td>
				...
				<span class="howto"><?php esc_html_e('Should subscribers be unsubscribed when the user with the email address is deleted?', 'wp-mailinglist'); ?></span>
			</td>
		</tr>
		<tr class="advanced-setting">
			<th><label for="resubscribe"><?php esc_html_e('Resubscribe Link', 'wp-mailinglist'); ?></label></th>
			<td>
				<label><input onclick="if (jQuery(this).is(':checked')) { jQuery('#resubscribe_div').show(); } else { jQuery('#resubscribe_div').hide(); }" <?php echo (!empty($resubscribe)) ? 'checked="checked"' : ''; ?> type="checkbox" name="resubscribe" value="1" id="resubscribe" /> <?php esc_html_e('Yes, provide a resubscribe link after unsubscribe.', 'wp-mailinglist'); ?></label>
...
<table class="form-table">
	<tbody>
		<tr>
			<th><label for="<?php echo esc_html( $this -> pre); ?>unsubscribetext"><?php esc_html_e('Unsubscription Link Text', 'wp-mailinglist'); ?></label>
		...
		<tr>
			...
			<td>
				...
				<span class="howto"><?php esc_html_e('Enable this to send the user/subscriber a "sorry to see you go..." email notification upon unsubscribe', 'wp-mailinglist'); ?></span>
			</td>
		</tr>
		<tr>
			<th><label for="unsubscribeconfirmation_Y"><?php esc_html_e('Unsubscribe Confirmation Screen', 'wp-mailinglist'); ?></label>
			<?php echo ( $Html -> help(__('This setting turns On/Off the unsubscribe confirmation screen which is a simple screen with checkboxes and a button so that subscribers can confirm their unsubscribe. It is considered a good feature since it will prevent invalid unsubscribes such as when an unsubscribe link is clicked by accident inside the email.', 'wp-mailinglist'))); ?></th>
			<td>
				...
				<span class="howto"><?php esc_html_e('Let subscribers confirm their unsubscribe. Turn this Off to unsubscribe immediately.', 'wp-mailinglist'); ?></span>
			</td>
		</tr>
	</tbody>
</table>
...
<table class="form-table">
	<tbody>
		...
		<tr>
			<th><?php esc_html_e('Admin Notification on Unsubscription', 'wp-mailinglist'); ?>
		...
		<tbody>
			<tr class="advanced-setting">
				...
				<td>
					...
					<span class="howto"><?php esc_html_e('Should the system send a single or multiple unsubscribe emails for an unsubscribe from multiple lists?', 'wp-mailinglist'); ?></span>
				</td>
			</tr>
		</tbody>
	</table>
