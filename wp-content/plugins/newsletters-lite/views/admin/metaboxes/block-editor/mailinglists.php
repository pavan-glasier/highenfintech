		                                ...
		                                switch ($field -> type) {
											...
											case 'pre_gender'		:
		                                        ...
		                                        <select style="max-width:250px;" name="newsletters_fields[<?php echo esc_html( $field -> slug); ?>]" id="fields_<?php echo esc_html( $field -> id); ?>" onchange="update_subscribers();">
		                                            ...
		                                            <option <?php echo (!empty($newsletters_fields[$field -> slug]) && $newsletters_fields[$field -> slug] == "other") ? 'selected="selected"' : ''; ?> value="other"><?php esc_html_e('Other', 'wp-mailinglist'); ?></option>
		                                        </select>
