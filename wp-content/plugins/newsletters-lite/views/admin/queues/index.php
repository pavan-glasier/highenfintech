					...
					<tbody>
						<?php foreach ($batch -> data as $key => $data) : ?>
							...
							<tr>
								...
								<td>
									<?php if (!empty($subscriber)) : ?>
										<label for="email-checkbox-<?php echo esc_html($key); ?>"><?php echo esc_url_raw( $Html -> get_gravatar($subscriber -> email)); ?></label>
									<?php elseif (!empty($user)) : ?>
										<label for="email-checkbox-<?php echo esc_html($key); ?>"><?php echo esc_url_raw( $Html -> get_gravatar($user -> user_email)); ?></label>
									<?php endif; ?>
								</td>
