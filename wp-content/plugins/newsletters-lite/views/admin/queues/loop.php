							...
							<?php if (!empty($screen_custom) && in_array('gravatars', $screen_custom)) : ?>
								<td>
									<?php if (!empty($subscriber)) : ?>
										<label for="checklist<?php echo esc_html( $queue -> id); ?>"><?php echo esc_url_raw( $Html -> get_gravatar($subscriber -> email)); ?></label>
									<?php elseif (!empty($user)) : ?>
										<label for="checklist<?php echo esc_html( $queue -> id); ?>"><?php echo esc_url_raw( $Html -> get_gravatar($user -> user_email)); ?></label>
									<?php endif; ?>
								</td>
							<?php endif; ?>
							<td>
