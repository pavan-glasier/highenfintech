...
<div class="newsletters newsletters-form-wrapper" id="newsletters-<?php echo esc_html($form -> id); ?>-form-wrapper">
	<form class="newsletters-subscribe-form" action="<?php echo esc_url_raw($Html -> retainquery($this -> pre . 'method=offsite&form=' . $form -> id, home_url())); ?>" method="post" id="newsletters-<?php echo esc_html($form -> id); ?>-form">
