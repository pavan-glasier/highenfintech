...
<form action="<?php echo esc_url_raw($action); ?>" method="post" id="<?php echo $widget_id; ?>-form" class="newsletters-subscribe-form">
	...
	<div id="<?php echo esc_html( $widget_id); ?>-submit" class="newsletters_submit">
		<span id="newsletters_buttonwrap">
			<button value="1" type="submit" class="button" name="subscribe" id="<?php echo esc_html( $widget_id); ?>-button">
...
jQuery(document).ready(function() {
	...
	<?php if (!empty($ajax) && $ajax == "Y") : ?>
		jQuery('#<?php echo esc_html( $widget_id); ?>-form').submit(function() {
			...
			jQuery('#<?php echo esc_html( $widget_id); ?>-button').button('disable');
